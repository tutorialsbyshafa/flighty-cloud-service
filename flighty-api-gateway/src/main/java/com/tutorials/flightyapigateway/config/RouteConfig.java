...
public class RouteConfig {
    ...
    public RouteLocator routes(RouteLocatorBuilder builder, RouteGatewayFilterFactory routeFactory) {
        return builder.routes()
                ...
                .route(Constant.MS_FLIGHT_ID, spec -> buildRoute(routeFactory, spec, Constant.MS_FLIGHT_PATH, Constant.MS_FLIGHT_ID, Constant.MS_FLIGHT_URI))
                .route(Constant.MS_BOOKING_ID, spec -> buildRoute(routeFactory, spec, Constant.MS_BOOKING_PATH, Constant.MS_BOOKING_ID, Constant.MS_BOOKING_URI))
                .build();
    }
